 ...
 * an action CLoadPlayersByPenaltiesScored.
 * Contains all the players ordered by the amount of pk they scored.
 */
public class CPlayersLoadedByPenaltiesScored extends CAction implements Serializable {

    private List<CPlayerEntity> mPlayers;

    public CPlayersLoadedByPenaltiesScored(){}
