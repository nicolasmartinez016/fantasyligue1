 ...
 * get the 15 best players ranked by the amount of saves
 * they made.
 */
public class CLoadPlayersBySaves extends CAction implements Serializable {

    public CLoadPlayersBySaves(){}
}
